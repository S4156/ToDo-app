...
## 🌐アプリURL
ユーザー名とパスワードの登録のみでお使いいただけます。無料版のPaaSを使用しているため、サービスがスリープしていることもあります。その場合は起動したまましばらくお待ちください。<br><br>
...
## 🚀今後の展望・課題
### 展望
- AIを活用し、ユーザーへのおすすめ動画を選んでくれる機能の追加。
- ポモドーロタイマー機能の追加。
- タスク完了時にポイントを貯め、そのポイントと景品を交換できる機能の追加。
